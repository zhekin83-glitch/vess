...
_FFMPEG = DepSpec(
    ...
    display_name="FFmpeg",
    description=(
        "Video / audio toolkit required by ClipSense for video probing, "
        "audio extraction, segment cutting / concatenation, and burning "
        "subtitles. All four editing modes depend on a working ffmpeg."
    ),
