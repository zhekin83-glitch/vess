...
This creates the skill directory, SKILL.md template, `agents/openai.yaml`, and optional resource directories in one step. Skill names are auto-normalized to hyphen-case.
...
interface:
  ...
  short_description: "Help with my skill tasks"
  default_prompt: "Use $my-skill to help me with this task"
...
- `get_skill_info` — inspect a skill's current content and metadata
