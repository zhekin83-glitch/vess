...
into subtitle-craft in 1.0.0 (forked from ``plugins/avatar-studio/avatar_studio_inline``);
see ``subtitle_craft_inline/__init__.py``. Reserved for future fan-out work
(e.g. parallel translation chunks); v1.0 pipeline does not call it yet.
"""
